...
function findWasmBinary() {
  return locateFile('webtextbox_demo.wasm');
}
...
var _RunWebTextboxDemo = Module['_RunWebTextboxDemo'] = makeInvalidEarlyAccess('_RunWebTextboxDemo');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['RunWebTextboxDemo'] != 'undefined', 'missing Wasm export: RunWebTextboxDemo');
  ...
  _RunWebTextboxDemo = Module['_RunWebTextboxDemo'] = createExportWrapper('RunWebTextboxDemo', 0);
