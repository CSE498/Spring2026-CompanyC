 ...
 * @note Status: FINAL
 *
 * @citation This world was developed with the help of Claude AI. The initial code was
...
{
    // Note: swap the filename for "dungeon_map_small.txt" to use the smaller test map.
    std::ifstream file("source/Worlds/interaction_world_maps/dungeon_map.txt");
    if (!file)
    {
