 ...
 * @note Status: FINAL
 * 
 * @citation: This world was developed with the help of Claude AI. The initial code was generated by Claude, and 
 * then iteratively refined and expanded by the authors. The dungeon layout was designed by the authors using 
 * donjon; RPG Tools (https://donjon.bin.sh/) and loaded from a text file.
 **/
#pragma once
