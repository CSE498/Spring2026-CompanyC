...
void ClassicDynamicAgent::BuildTree() {
    ...
    // Branch 7. GATHERING
    // ==================================================
    // TODO: auto gather_branch = std::make_shared<Sequence>("GatherBranch");

    // auto need_to_gather = std::make_shared<ConditionNode>(
    //     "NeedToGather",
    //     [](const Blackboard & bb) -> bool {
    //         return true;
    //     }
    ...
    // dynamic_root->addChild(gather_branch);

    this->tree.setRoot(dynamic_root);
}
