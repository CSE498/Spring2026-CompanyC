...
namespace cse498 
{
    ...
    std::unique_ptr<WebLayout::Node> WebLayout::buildTreeFromDom(const emscripten::val& el, std::unique_ptr<Node> parent)
    {
        auto uid = makeUid();
    ...
    void WebLayout::hydrateMetaData(std::unique_ptr<Node> n)
    {
        // tagName
